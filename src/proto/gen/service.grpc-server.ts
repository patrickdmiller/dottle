...
// tslint:disable
import { FinishDotProcessResponse } from "./service";
import { FinishDotProcessRequest } from "./service";
...
export interface ICoordinatorService extends grpc.UntypedServiceImplementation {
     ...
     */
    finishDotProcess: grpc.handleUnaryCall<FinishDotProcessRequest, FinishDotProcessResponse>;
}
/**
...
export const coordinatorServiceDefinition: grpc.ServiceDefinition<ICoordinatorService> = {
    ...
    finishDotProcess: {
        path: "/dottle.CoordinatorService/FinishDotProcess",
        originalName: "FinishDotProcess",
        requestStream: false,
        responseStream: false,
        responseDeserialize: bytes => FinishDotProcessResponse.fromBinary(bytes),
        requestDeserialize: bytes => FinishDotProcessRequest.fromBinary(bytes),
        responseSerialize: value => Buffer.from(FinishDotProcessResponse.toBinary(value)),
        requestSerialize: value => Buffer.from(FinishDotProcessRequest.toBinary(value))
    }
};
